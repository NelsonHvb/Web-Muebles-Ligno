            ...
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu">
                  ...
                  <a class="dropdown-item" href="{{ route('testimonials') }}">Testimonios</a>
                  <a class="dropdown-item" href="{{ route('terms') }}">Términos</a>
                </div>
              </li>
              <a class="nav-link" href="{{ route('checkout') }}">Proceso de pago</a>
            ...
            @auth
              <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="#" id="userMenu" role="button"
                  ...
                  {{ auth()->user()->Usuario ?? auth()->user()->name ?? 'Mi cuenta' }}
                </a>
